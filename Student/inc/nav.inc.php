...
<nav class="navbar w3-text-white" id="navbar">
    <div class="container">
        ...
        <div class="navbar-header">
            <a href="" class="navbar-brand w3-text-white"><strong>Student Dashboard</strong></a>
        </div><!-- end navbar-header -->
        <!--<div class="nav-collapse collapse nav-responsive-collapse">-->

        <ul class="nav navbar-nav side_nav text-center">
            <li><a href="registered_units.php" class="lec"><span class="fa fa-th-list"></span>&emsp;Registered Units</a></li>
        ...
        <ul class="nav navbar-nav navbar-right side_nav">
            <li class="dropdown">
                <a class="dropdown-toggle w3-text-white" data-toggle="dropdown" href="#">
                    <strong><i class="fa fa-graduation-cap"></i>&emsp;<?php echo $_SESSION['student'] ?>&emsp;<span class="caret"></span></strong>
                </a>
                <ul class="dropdown-menu">
                    <!--<li><a href="lec_edit_profile.php" class="lec"><i class="fa fa-plus-circle"></i>&emsp;Edit Account</a></li>
                    <li><a href="lec_edit_profile.php" class="lec"><i class="fa fa-book"></i>&emsp;Change Password</a></li>-->
