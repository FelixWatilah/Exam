        ...
        <div id="lec_content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title text-center">Results for <?php echo $_SESSION['student'] ?></h4>
                </div>
                                    ...
                                    if ($subject == true){
                                        ...
                                        if ($row['stud_adm'] != '' && $sub['stud_adm'] != ''){
                                            ...
                                            echo "<tbody>
                                                            ...
                                                            &emsp;You might have not done the exams for this semester.
                                                            </strong>
                                                            </h4>
